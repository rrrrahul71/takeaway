angular.module('TakeAwaySaver.result', [])
.controller('resultCtrl',resultCtrl);
	this.resultText = 'This is the Result component!';
	function resultCtrl ($scope, $mdDialog) {
	    $scope.status = '';
	    $scope.vm = {
              formData: {
    	...
    	$scope.showSignup = function(event) {
           $mdDialog.show({
              ...
              template: '<md-dialog flex-gt-sm="50" flex="90">' +
                          ...
                          '  </md-dialog-content>' +
                          '</md-dialog>',
              controller: function resultCtrl($scope, $mdDialog) {
