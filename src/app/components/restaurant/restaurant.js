angular.module('TakeAwaySaver.restaurant', [])
.controller('restaurantCtrl',restaurantCtrl);
	this.resultText = 'This is the restaurant component!';
	function restaurantCtrl ($scope, $mdDialog) {
	    $scope.status = '';
	    $scope.vm = {
              formData: {
    	...
    	$scope.showSignup = function(event) {
           $mdDialog.show({
              ...
              template: '<md-dialog flex-gt-sm="50" flex="90">' +
                          ...
                          '  </md-dialog-content>' +
                          '</md-dialog>',
              controller: function restaurantCtrl($scope, $mdDialog) {
