angular.module('TakeAwaySaver.menu', [])
.controller('menuCtrl',menuCtrl);
	//this.menuText = 'This is the Result component!';
	function menuCtrl ($scope, $mdDialog) {
	    $scope.status = '';
	    $scope.vm = {
              formData: {
    	...
    	$scope.showSignup = function(event) {
           $mdDialog.show({
              ...
              template: '<md-dialog flex-gt-sm="50" flex="90">' +
                          ...
                          '  </md-dialog-content>' +
                          '</md-dialog>',
              controller: function menuCtrl($scope, $mdDialog) {
